(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('jHipsterPlaygroundApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-jHipsterPlaygroundApp-error');
                var entityKey = httpResponse.headers('X-jHipsterPlaygroundApp-params');
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('jHipsterPlaygroundApp.' + fieldError.objectName + '.' + convertedField);
